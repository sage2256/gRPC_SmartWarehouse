...
public final class AutomateOrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest,
      smartwarehouse.AutomateOrder.Confirmation> getMakeOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MakeOrder",
      requestType = smartwarehouse.AutomateOrder.OrderRequest.class,
      responseType = smartwarehouse.AutomateOrder.Confirmation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest,
      smartwarehouse.AutomateOrder.Confirmation> getMakeOrderMethod() {
    io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest, smartwarehouse.AutomateOrder.Confirmation> getMakeOrderMethod;
      ...
      synchronized (AutomateOrderServiceGrpc.class) {
        if ((getMakeOrderMethod = AutomateOrderServiceGrpc.getMakeOrderMethod) == null) {
          AutomateOrderServiceGrpc.getMakeOrderMethod = getMakeOrderMethod = 
              io.grpc.MethodDescriptor.<smartwarehouse.AutomateOrder.OrderRequest, smartwarehouse.AutomateOrder.Confirmation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "smartwarehouse.AutomateOrderService", "MakeOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  smartwarehouse.AutomateOrder.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  smartwarehouse.AutomateOrder.Confirmation.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest,
      smartwarehouse.AutomateOrder.Confirmation> getStopOrderMethod;
  ...
  public static io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest,
      smartwarehouse.AutomateOrder.Confirmation> getStopOrderMethod() {
    io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest, smartwarehouse.AutomateOrder.Confirmation> getStopOrderMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest,
      smartwarehouse.AutomateOrder.OrderStatus> getStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Status",
      requestType = smartwarehouse.AutomateOrder.OrderRequest.class,
      responseType = smartwarehouse.AutomateOrder.OrderStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest,
      smartwarehouse.AutomateOrder.OrderStatus> getStatusMethod() {
    io.grpc.MethodDescriptor<smartwarehouse.AutomateOrder.OrderRequest, smartwarehouse.AutomateOrder.OrderStatus> getStatusMethod;
    if ((getStatusMethod = AutomateOrderServiceGrpc.getStatusMethod) == null) {
      synchronized (AutomateOrderServiceGrpc.class) {
        if ((getStatusMethod = AutomateOrderServiceGrpc.getStatusMethod) == null) {
          AutomateOrderServiceGrpc.getStatusMethod = getStatusMethod = 
              io.grpc.MethodDescriptor.<smartwarehouse.AutomateOrder.OrderRequest, smartwarehouse.AutomateOrder.OrderStatus>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  smartwarehouse.AutomateOrder.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  smartwarehouse.AutomateOrder.OrderStatus.getDefaultInstance()))
  ...
  public static abstract class AutomateOrderServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void makeOrder(smartwarehouse.AutomateOrder.OrderRequest request,
        io.grpc.stub.StreamObserver<smartwarehouse.AutomateOrder.Confirmation> responseObserver) {
      asyncUnimplementedUnaryCall(getMakeOrderMethod(), responseObserver);
    }

    /**
     */
    public void stopOrder(smartwarehouse.AutomateOrder.OrderRequest request,
        io.grpc.stub.StreamObserver<smartwarehouse.AutomateOrder.Confirmation> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<smartwarehouse.AutomateOrder.OrderRequest> status(
        io.grpc.stub.StreamObserver<smartwarehouse.AutomateOrder.OrderStatus> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                smartwarehouse.AutomateOrder.OrderRequest,
                smartwarehouse.AutomateOrder.Confirmation>(
          ...
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                smartwarehouse.AutomateOrder.OrderRequest,
                smartwarehouse.AutomateOrder.OrderStatus>(
  ...
  public static final class AutomateOrderServiceBlockingStub extends io.grpc.stub.AbstractStub<AutomateOrderServiceBlockingStub> {
    ...
    /**
     */
    public smartwarehouse.AutomateOrder.Confirmation makeOrder(smartwarehouse.AutomateOrder.OrderRequest request) {
    ...
    /**
     */
    public smartwarehouse.AutomateOrder.Confirmation stopOrder(smartwarehouse.AutomateOrder.OrderRequest request) {
      return blockingUnaryCall(
  ...
  public static final class AutomateOrderServiceFutureStub extends io.grpc.stub.AbstractStub<AutomateOrderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<smartwarehouse.AutomateOrder.Confirmation> makeOrder(
        smartwarehouse.AutomateOrder.OrderRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<smartwarehouse.AutomateOrder.Confirmation> stopOrder(
        smartwarehouse.AutomateOrder.OrderRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MAKE_ORDER:
          serviceImpl.makeOrder((smartwarehouse.AutomateOrder.OrderRequest) request,
              (io.grpc.stub.StreamObserver<smartwarehouse.AutomateOrder.Confirmation>) responseObserver);
          break;
        case METHODID_STOP_ORDER:
          serviceImpl.stopOrder((smartwarehouse.AutomateOrder.OrderRequest) request,
              (io.grpc.stub.StreamObserver<smartwarehouse.AutomateOrder.Confirmation>) responseObserver);
          break;
        default:
  ...
  private static abstract class AutomateOrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return smartwarehouse.AutomateOrder.getDescriptor();
    }
